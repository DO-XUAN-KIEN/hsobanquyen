...
//		System.out.println(tem);
    ...
    public static short[] Ratio_Upgrade_Medal = new short[]{10000, 10000, 10000, 6666, 5555, 4444, 3333, 2222, 1111, 1111, 999, 888, 777, 666, 555, 222};// op
            ...
            case 0: { // bán
                if (conn.p.item.total_item_by_id(4, 135) > 0) {
                    ...
                    for (int i = 0; i < size; i++) {
                        ...
                        if (p_store.it_price > 1_000_000 || p_store.it_price < 10_000 && Manager.gI().event == 7){
                            Service.send_notice_box(conn,"Giá bán không được quá 1_000_000");
                            return;
                        }
