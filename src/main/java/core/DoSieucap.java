...
public class DoSieucap {
    ...
    public static short[] ti_le_nang_do = new short[]{2000, 1500, 1000, 800, 600, 500, 400, 300, 200, 100, 50, 30, 20, 1, 1,1};
...
//            }
    ...
    public static short[] ti_le_nang_md = new short[]{2000, 1500, 1000, 800, 600, 500, 400, 300, 200, 100, 50, 30, 20, 1, 1,1};
