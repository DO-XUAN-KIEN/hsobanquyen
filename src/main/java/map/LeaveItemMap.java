        ...
        if (mob != null && mob.isBoss()) {
          ...
          //  short id_medal_material = -19;
            ...
            switch (mob.template.mob_id) {
                case 101: { // xa nu
                    id_item_leave4 = new short[]{-1, -1, -1, -1, -1, -1, 344};
                    id_sk = new short[]{(short) Util.random(146,246)};
                ...
                case 103: { // bo cap chua
                    id_item_leave4 = new short[]{-1, -1, -1, -1, -1, -1,344, 48, 50, 18, 9, 48, 50, 18, 9, 2, 5, 2, 5, 2, 5, 2, 5};
                    id_sk = new short[]{(short) Util.random(146,246)};
                    if(Util.random(100)<10){
                        id_item_leave4 = new short[]{(short) Util.random(319,323)};
                    }
                ...
                case 104: { // quy 1 mat
                    id_item_leave4 = new short[]{-1, -1, -1, -1, -1, -1, 10, 10,344};
                    id_sk = new short[]{(short) Util.random(146,246)};
                    if(Util.random(100)<10){
                        id_item_leave4 = new short[]{(short) Util.random(319,323)};
                    }
                ...
                case 105: { // quy dau bo
                    id_item_leave4 = new short[]{-1, -1, -1, -1, -1, -1, 49, 49,344};
                    id_sk = new short[]{(short) Util.random(146,246)};
                    if(Util.random(100)<10){
                        id_item_leave4 = new short[]{(short) Util.random(319,323)};
                    }
                ...
                case 106: { // ky sy dia nguc
                    id_item_leave4 = new short[]{-1, -1, -1, -1, -1, -1, 18,344};
                    id_sk = new short[]{(short) Util.random(146,246)};
                    if(Util.random(100)<10){
                        id_item_leave4 = new short[]{(short) Util.random(319,323)};
                    }
...
//                    }
                    ...
                    case 173: { //tho tuyet
                        id_item_leave4 = new short[]{-1, -1, -1, -1, -1, -1, 273, 274, 251, 319, 320, 321, 322,344};
                        id_sk = new short[]{(short) Util.random(146,246)};
                        if(Util.random(100)<10){
                            id_item_leave4 = new short[]{(short) Util.random(319,323)};
                        }
                    ...
                    case 193: {
                        id_item_leave4 = new short[]{-1, -1, -1, -1, -1, -1, 273, 274,344, 251, 319, 320, 321, 322, 342, 343, 344, 346};
