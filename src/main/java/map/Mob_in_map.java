    ...
    public void SetDie(Map map, MainObject mainAtk) throws IOException {
        ...
        if (mob.isBoss()) {
            ...
            if (!Map.is_map_cant_save_site(mob.map_id)) {
               ...
               Manager.gI().chatKTGprocess("" + mainAtk.name + "đã gây ra" + top_dame + " Đã Nhận Quà 1 Top Sát Thương Đánh " + mob.template.name + "");
...
//                    if(map.map_id == 61){
//                        LeaveItemMap.leave_item_8(map, mob, (Player) mainAtk);
//                    }
